...
import Event from "../AdminMentor/components/AllEvent/app/Event";
import Availability from "./components/Availability/components/app/Availability";
          ...
          >
            ...
            <span
              className={`${styles.label} ${
                activeOption === option.id ? styles.activeLabel : ""
              }`}
            >
              {option.label}
            </span>
